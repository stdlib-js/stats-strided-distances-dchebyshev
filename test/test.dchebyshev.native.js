...
var dchebyshev = tryRequire( resolve( __dirname, './../lib/dchebyshev.native.js' ) );
var opts = {
...
tape( 'the function calculates the Chebyshev distance between two strided arrays', opts, function test( t ) {
	var d;
	var x;
	var y;
